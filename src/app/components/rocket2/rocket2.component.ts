...
@Component({
  ...
  styleUrls: ['./rocket2.component.scss']
})

export class Rocket2Component {
  ...
  increaseDamage(): void {
    ...
    this.playerService.increaseDamage(1,'2'); // Increase damage by 1
  }


  increaseSpeed(): void {

    this.playerService.increaseSpeed(1,'2'); // Increase damage by 1
  }
